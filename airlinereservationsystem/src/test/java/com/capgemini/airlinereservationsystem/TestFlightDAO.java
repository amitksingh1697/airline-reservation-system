...
public class TestFlightDAO {
	...
	/*
	 * @Test public void updateFlightTest() { FlightInformation flightInformation =
	 * new FlightInformation(); flightInformation.setAirline("Vistara");
	 * assertEquals(true,flightDAO.updateFlight(flightInformation)); }
	 */
